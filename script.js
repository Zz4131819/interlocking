 ...
 */
import { initCanvas, clearCanvas, drawRect, drawPolygon, hexToRgba } from './canvas.js';
const { canvas, ctx } = initCanvas("designCanvas");
...
import { createCheckerboardPattern, createBorderPattern, createCustomBorderPattern } from './patterns.js';
